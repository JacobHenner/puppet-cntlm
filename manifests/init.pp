...
class cntlm (
    ...
    String $cntlm_domain,
    Optional[Sensitive[String]] $cntlm_password,
    Optional[Sensitive[String]] $cntlm_passlm,
    Optional[Sensitive[String]] $cntlm_passnt,
    Optional[Sensitive[String]] $cntlm_passntlmv2,
    Optional[String] $cntlm_workstation,
    Array[String] $cntlm_proxy,
    Optional[String] $cntlm_noproxy,
    Optional[String] $cntlm_listen,
    Optional[Array[String]] $cntlm_socks5proxy,
    Optional[Array[Sensitive[String]]] $cntlm_socks5user,
    Optional[String] $cntlm_auth,
    Optional[String] $cntlm_flags,
    Boolean $cntlm_gateway,
    Optional[Array[String]] $cntlm_allow,
    Optional[Array[String]] $cntlm_deny,
    Optional[Integer] $cntlm_isascannersize,
    Optional[Array[String]] $cntlm_isascanneragent,
    Optional[Array[String]] $cntlm_header,
    Optional[Array[String]] $cntlm_tunnel,
) {
